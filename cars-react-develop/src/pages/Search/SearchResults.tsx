...
const VehicleTable: FC<{
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_: any, record: Car) => (
                <Space direction="vertical">
                    ...
                    <Text>Lot {record?.lots?.[0]?.lot}</Text>
        ...
        },
        {
            ...
            render: (_: any, record: Car) => (
                <Space direction="vertical">
                    <Text className="text-gray-600">Odometer: </Text>
                    <Text strong>
                    ...
                    <Text strong>
                        ${record?.lots?.[0]?.actual_cash_value || "N/A"}
                    </Text>
                </Space>
            ),
            responsive: ["xs", "sm", "md", "lg", "xl", "xxl"],
        },
        {
            ...
            render: (_: any, record: Car) => (
                <Space direction="vertical">
                    ...
                    <div>
                        <Text className="text-gray-600">Damage: </Text>
                        <Text strong>
                            {record?.lots?.[0]?.damage?.main?.name || "None"}
                        </Text>
                    </div>
                    <div>
                        <Text className="text-gray-600">Second Damage: </Text>
                        <Text strong>
            ...
            render: (_: any, record: Car) => (
                <Space direction="vertical">
                    <div>
                        ...
                        <Text strong>
                            {record?.lots?.[0]?.selling_branch?.name}
                        </Text>
                    </div>
                    <div>
                        <Text className="text-gray-600">Date: </Text>
                        <Text strong>
                            {formatSaleDate(record?.lots?.[0]?.sale_date)}
                        </Text>
                    </div>
                    <div>
                        <Text className="text-gray-600">Seller: </Text>
                        <Text strong>
                            {record?.lots?.[0]?.seller?.name || "Unknown"}
                        </Text>
                    </div>
                </Space>
            ),
            ...
            render: (_: any, record: Car) => (
                <Space direction="vertical">
                    {filter?.buyItNow ? (
                        ...
                        <>
                            <Text>
                                Current Bid ${record?.lots?.[0]?.bid || "0"}
                            </Text>
                        </>
                    )}
                </Space>
